...
SAMPLE_STOCKS = [
    ...
    {'ticker': 'HUT', 'exchange': 'NASDAQ', 'price': 14.62, 'change': 12.1, 'name': 'Hut 8 Corp', 'nameHE': 'Hut 8 Corp', 'why': 'Bitcoin mining and HPC capacity growth', 'whyHE': 'צמיחת כרייה ותשתיות HPC', 'sentiment': 'BULLISH', 'marketCap': '$2.9B', 'volume': '+12.1%', 'reddit': True},
    ...
    {'ticker': 'WULF', 'exchange': 'NASDAQ', 'price': 6.89, 'change': 4.2, 'name': 'TeraWulf Inc', 'nameHE': 'TeraWulf', 'why': 'Sustainable mining capacity increase', 'whyHE': 'עלייה בכושר כרייה בר-קיימא', 'sentiment': 'BULLISH', 'marketCap': '$2.1B', 'volume': '+4.2%', 'reddit': True},
    {'ticker': 'IREN', 'exchange': 'NASDAQ', 'price': 18.45, 'change': 6.8, 'name': 'Iris Energy Ltd', 'nameHE': 'Iris Energy', 'why': 'AI data center expansion news', 'whyHE': 'חדשות הרחבת מרכזי נתונים AI', 'sentiment': 'BULLISH', 'marketCap': '$3.4B', 'volume': '+6.8%', 'reddit': True}
]
...
def generate_stock_card(stock):
    ...
    <div class="card">
      ...
      <div class="links">
        ...
        <a href="https://www.google.com/finance/quote/{stock['ticker']}:{stock['exchange']}" target="_blank" rel="noopener noreferrer">🔎 Google Finance</a>
      </div>
      <div class="disclaimer">Sample/demo data, not a live feed — verify via links above.</div>
    </div>
    """
